...
- **Fase actual**: F5 (caja + config + deploy) en curso — 4/16 (pagos F5-03..06 ✅). F4 ✅ completa 22/22 @2026-09-05 (E2E contra Neon). Restan 12 tareas (F5: 12).
...
| **TOTAL** | — | **108** | **96** | F0 (8) + F1 (14) + F2 (22) + F3 (26) + F4 (22) + F5 (4) completas. Restan 12 (F5). |
